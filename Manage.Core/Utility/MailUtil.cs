...
namespace Manage.Core.Utility
{
    public class MailUtil
    {
        ...
        /// 邮件服务器地址
        /// </summary>
        private static string MailServer = ConfigUtil.GetValue("MailHost");
        /// <summary>
        /// 用户名
        /// </summary>
        private static string MailUserName = ConfigUtil.GetValue("MailUserName");
        /// <summary>
        /// 密码
        /// </summary>
        private static string MailPassword = ConfigUtil.GetValue("MailPassword");
        /// <summary>
        /// 名称
        /// </summary>
        private static string MailName = ConfigUtil.GetValue("MailName");
